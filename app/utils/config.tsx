...
// Language toggle removed - Aura is English-only
...
// Default enabled menu items - Trading, Portfolio, Markets, Social, Leaderboard, Rewards
    ...
    return {
      scaffold: {
        mainNavProps: {
          ...
          // External links removed for Aura branding
