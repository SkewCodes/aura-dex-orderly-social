...
const translations: TranslationDictionary = {
  ...
  'trading.chartDisclaimer': {
    KO: '* Aura provides real-time charts through TradingView, allowing you to easily track various symbols including BTCUSD. The user-friendly interactive charts and various analysis tools make market analysis much more efficient and smooth.',
    EN: '* Aura provides real-time charts through TradingView, allowing you to easily track various symbols including BTCUSD. The user-friendly interactive charts and various analysis tools make market analysis much more efficient and smooth.'
  },
  'trading.usdtFutures': {
    KO: 'USDT 선물',
    EN: 'USDT Futures'
