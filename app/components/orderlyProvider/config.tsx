...
export async function initOnBoard() {
  ...
  return Promise.resolve().then(() => {
    ...
    onboardInstance = init({
      ...
      appMetadata: {
        name: "Aura",
        description: "Aura - Social Trading Platform",
        icon: `${import.meta.env.VITE_BASE_URL || ""}/logo-secondary.svg`,
      },
      theme: {
        "--w3o-background-color": "#060a12",
        "--w3o-foreground-color": "#101623",
        "--w3o-text-color": "#ffffff",
        "--w3o-border-color": "#1c2232",
        "--w3o-action-color": "#00d4ff",
        "--w3o-border-radius": "16px",
        "--w3o-font-family": "IBM Plex Sans, sans-serif",
      },
      accountCenter: {
        desktop: {
          enabled: false,
