                ...
                <div className="dc-w-490 dc-h-680 dc-flex dc-gap-12">
                    ...
                    <div className="dc-w-245 dc-h-680 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-[#1F2126] dc-rounded-[20px] dc-p-8">
                        ...
                        <div className="dc-h-28 dc-flex dc-w-full dc-items-center dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-white dc-border-opacity-6 dc-rounded-[8px] dc-mb-16">
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-20 ${calculatedPercentage === 10 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(10)}
                            >
                                10%
                            </button>
                            <button
                                className={`dc-w-1/5 dc-h-20 dc-flex dc-items-center dc-justify-center dc-text-10 ${calculatedPercentage === 25 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(25)}
                            >
                                25%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-20 ${calculatedPercentage === 50 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(50)}
                            >
                                50%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-20 ${calculatedPercentage === 75 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(75)}
                            >
                                75%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-20 ${calculatedPercentage === 100 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                ...
                <div className="dc-min-h-400 dc-p-4">
                    ...
                    <div className="dc-flex dc-items-center dc-justify-between dc-h-48 dc-mb-4">
                        <div className="dc-p-8 dc-flex dc-items-center dc-justify-between dc-bg-gradient-to-br dc-from-[#131416] dc-to-[#0A0A0B] dc-border dc-border-white dc-border-opacity-6 dc-rounded-[16px]">
                            <button
                                className={`dc-px-20 dc-h-32 dc-text-14 ${activeOrderTab === "Position" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[12px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Position")}
                            >
                                {t('trading.position')}({positions.length})
                            </button>
                            <button
                                className={`dc-px-20 dc-h-32 dc-text-14 ${activeOrderTab === "Current Orders" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[12px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Current Orders")}
                            >
                                {t('trading.currentOrders')}({orders.filter(order => order.status === "PENDING").length})
                            </button>
                            <button
                                className={`dc-px-20 dc-h-32 dc-text-14 ${activeOrderTab === "Order History" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[12px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Order History")}
                            >
                                {t('trading.orderHistory')}
                            </button>
                            <button
                                className={`dc-px-20 dc-h-32 dc-text-14 ${activeOrderTab === "PnL" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[12px]" : "dc-text-white"}`}
