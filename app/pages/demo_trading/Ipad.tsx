...
import IpadTradingStats from "~/components/IpadTradingStats";
...
export default function Ipad({
    ...
    return (
        <div className="md:dc-block xl:dc-hidden dc-bg-black/20 dc-hidden dc-w-full dc-min-h-screen dc-px-16 dc-py-10 dc-rounded-[20px] dc-border dc-border-[#1F2126]">
            <IpadTradingStats symbol={activeTab} />
            ...
            <div className="dc-flex dc-w-full dc-gap-12">
                {/* Left Column - Chart */}
                <div className="dc-w-[calc(100%-490px)] dc-h-456">
                    <div className="dc-h-[calc(100%-32px)]">
                        <TradingViewWidget symbol={activeTab} />
                    </div>
                    <p className="dc-text-9 dc-text-[#A4A8AB] dc-mt-1">
                        {t('trading.chartDisclaimer')}
                    </p>
                </div>

                {/* Right Column - Order Book & Trading Form */}
                <div className="dc-w-490 dc-h-456 dc-flex dc-gap-12">
                    {/* Order Book */}
                    <div className="dc-min-w-245 dc-w-245 dc-h-456 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-[#1F2126] dc-rounded-[20px] dc-p-5">
                        <div className="dc-flex dc-justify-between dc-h-24 dc-p-3 dc-gap-3 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-rounded-[12px] dc-border dc-border-[#1F2126] dc-mb-6">
                            <button
                                className={`dc-text-10 dc-w-1/2 dc-h-14 dc-flex dc-items-center dc-justify-center ${activeDisplayTab === "Order Book" ? "dc-text-white dc-bg-gradient-to-br dc-from-[#1C1E21] dc-to-[#111316]" : "dc-text-[#898D99]"} dc-outline-none dc-rounded-[8px]`}
                                onClick={() => setActiveDisplayTab("Order Book")}
                            >
                                {t('trading.orderBook')}
                            </button>
                            <button
                                className={`dc-text-10 dc-w-1/2 dc-h-14 dc-flex dc-items-center dc-justify-center ${activeDisplayTab === "Recent Trades" ? "dc-text-white dc-bg-gradient-to-br dc-from-[#1C1E21] dc-to-[#111316]" : "dc-text-[#898D99]"} dc-outline-none dc-rounded-[8px]`}
                        ...
                        {activeDisplayTab === "Order Book" && (
                            <>
                                {orderbookMode === 1 && (
                                    <div className="dc-flex dc-flex-col dc-w-full dc-h-[calc(100%-30px)] dc-overflow-hidden dc-bg-[#100e0e]">
                                        {/* Order Book Header */}
                                        <div className="dc-px-6 dc-text-9 dc-h-16 dc-bg-[#0F0F0F] dc-flex dc-items-center dc-justify-between dc-mb-3 dc-text-[#A4A8AB]">
                                        ...
                                        {/* Ask Orders (Sell) */}
                                        <div className="dc-flex dc-flex-col dc-w-full dc-gap-1 dc-px-6 dc-mb-1">
                                            {askOrders.map((order, index) => (
                                                <div key={`ask-${index}`} className="dc-text-11 dc-h-14 dc-relative dc-flex dc-items-center dc-justify-between">
                                        ...
                                        {/* Price Indicator */}
                                        <div className="dc-text-12 dc-flex dc-items-center dc-justify-center dc-w-full dc-h-24 dc-gap-4 dc-mb-2">
                                            ...
                                            <span className="dc-flex dc-items-center">
                                                <span className="dc-mr-6 dc-text-white">⚑</span>
                                                <span>{Number(avgPrice).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                            </span>
                                        </div>

                                        {/* Bid Orders (Buy) */}
                                        <div className="dc-flex dc-flex-col dc-w-full dc-gap-1 dc-px-6 dc-mb-2">
                                            {bidOrders.map((order, index) => (
                                                <div key={`bid-${index}`} className="dc-text-12 dc-relative dc-flex dc-items-center dc-justify-between dc-h-16">
                                        ...
                                        <div className="dc-h-28 buy-sell-indicator dc-flex dc-flex-col dc-w-full dc-px-8">
                                            <div className="dc-flex dc-items-center dc-justify-between dc-mb-4">
                                                <div className="dc-flex dc-items-center dc-mr-4">
                                                    <div className="dc-w-16 dc-h-16 dc-rounded-sm dc-bg-[#FF2B64] dc-mr-4"></div>
                                                ...
                                                <div className="dc-flex dc-items-center dc-ml-4">
                                                    ...
                                                    <div className="dc-w-16 dc-h-16 dc-rounded-sm dc-bg-[#3FB185] dc-ml-4"></div>
                                                </div>
                                            </div>
                                ...
                                {orderbookMode === 2 && (
                                    <div className="dc-flex dc-flex-col dc-w-full dc-h-[calc(100%-30px)]">
                                        {/* Price Indicator */}
                                        <div className="dc-text-14 dc-h-28 dc-flex dc-items-center dc-justify-center dc-w-full dc-gap-6 dc-mb-2">
                                        ...
                                        {/* Order Book Header */}
                                        <div className="dc-px-8 dc-text-12 dc-h-28 dc-bg-[#0F0F0F] dc-flex dc-items-center dc-justify-between dc-mb-6 dc-text-white">
                                        ...
                                        <div className="dc-flex dc-flex-col dc-w-full dc-gap-6 dc-px-8 dc-mb-2">
                                            {Array.from({ length: Math.max(askOrders.length, bidOrders.length) }).map((_, index) => (
                                                <div key={`row-${index}`} className="dc-text-12 dc-min-h-16 dc-flex dc-items-center">
                                                    {/* Bid Side */}
                                ...
                                {orderbookMode === 4 && (
                                    <div className="dc-flex dc-flex-col dc-w-full dc-h-[calc(100%-30px)]">
                                        ...
                                        <div className="dc-flex dc-flex-col dc-w-full dc-gap-6 dc-px-8 dc-mb-2">
                                            {askOrders.map((order, index) => (
                                                <div key={`ask-${index}`} className="dc-text-12 dc-relative dc-flex dc-items-center dc-justify-between dc-h-16">
                                                    <div className="dc-bg-[#3FB185] dc-bg-opacity-16 dc-absolute dc-top-0 dc-right-0 dc-h-full" style={{ width: `${smoothedAsks[index]?.percentRatio || 0}%`, zIndex: 0, transition: 'width 0.2s ease-out' }}></div>
                        ...
                        {activeDisplayTab === "Recent Trades" && (
                            <div className="dc-flex dc-flex-col dc-w-full dc-h-[calc(100%-50px)]">
                                ...
                                {/* Recent Trades List */}
                                <div className="dc-flex dc-flex-col dc-w-full dc-h-[calc(100%-28px)] dc-px-8 dc-overflow-auto">
                                    {recentTrades.length > 0 ? (
                                        recentTrades.map((trade, index) => {
                                            ...
                                            return (
                                                <div key={`trade-${index}`} className="dc-text-12 dc-min-h-20 dc-flex dc-items-center dc-justify-between">
                                                    <span className={`dc-w-1/3 ${trade.type === 'buy' ? 'dc-text-[#3FB185]' : 'dc-text-[#FF2B64]'}`}>
                                                        {Number(parseFloat(trade.price)).toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}
                                                        {isPriceDifferent && (trade.type === 'buy' ? '↑' : '↓')}
                                                    </span>
                                                    <span className="dc-w-1/3 dc-text-right">{Number(trade.qty).toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 })}</span>
                                        ...
                                        <div className="dc-text-12 dc-flex dc-items-center dc-justify-center dc-h-24">
                    ...
                    {/* Trading Form */}
                    <div className="dc-w-245 dc-h-456 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-[#1F2126] dc-rounded-[20px] dc-p-5">
                        {/* Order Type Tabs */}
                        <div className="dc-flex dc-justify-between dc-h-24 dc-p-3 dc-gap-3 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-rounded-[12px] dc-border dc-border-[#1F2126] dc-mb-6">
                            <button
                                className={`dc-text-10 dc-w-1/2 dc-h-14 dc-flex dc-items-center dc-justify-center ${orderType === "LIMIT" ? "dc-text-white dc-bg-gradient-to-br dc-from-[#1C1E21] dc-to-[#111316]" : "dc-text-[#898D99]"} dc-outline-none dc-rounded-[8px]`}
                                onClick={() => setOrderType("LIMIT")}
                            >
                                {t('trading.limit')}
                            </button>
                            <button
                                className={`dc-text-10 dc-w-1/2 dc-h-14 dc-flex dc-items-center dc-justify-center ${orderType === "MARKET" ? "dc-text-white dc-bg-gradient-to-br dc-from-[#1C1E21] dc-to-[#111316]" : "dc-text-[#898D99]"} dc-outline-none dc-rounded-[8px]`}
                        ...
                        {/* Position Type */}
                        <div className="dc-h-22 dc-text-10 dc-flex dc-justify-between dc-w-full dc-gap-3 dc-mb-5">
                            <div
                                className="dc-bg-opacity-2 dc-border-opacity-6 flex-grow basis-0 dc-flex dc-items-center dc-justify-between dc-h-full dc-px-8 dc-py-6 dc-bg-white dc-border dc-border-white dc-rounded-[8px] dc-cursor-pointer"
                            ...
                            >
                                ...
                                <ChevronDownIcon className="dc-w-16 dc-h-16" color="#00D4FF" />
                            </div>
                            <div
                                className="dc-bg-opacity-2 dc-border-opacity-6 flex-grow basis-0 dc-flex dc-items-center dc-justify-between dc-h-full dc-px-8 dc-py-6 dc-bg-white dc-border dc-border-white dc-rounded-[8px] dc-cursor-pointer"
                        ...
                        {/* Price Input */}
                        <div className="dc-mb-5">
                            <div className={`dc-h-22 dc-flex dc-items-center dc-justify-between dc-bg-white dc-bg-opacity-2 dc-border dc-border-white dc-border-opacity-6 dc-rounded-[8px] dc-px-6`}>
                                {orderType === "MARKET" ? (
                                ...
                                <div className={`dc-flex dc-items-center ${orderType === "MARKET" ? "dc-opacity-50" : ""}`}>
                                    <div
                                        className={`dc-flex dc-items-center dc-justify-center dc-w-20 dc-h-20 dc-text-11 dc-text-[#00D4FF] dc-underline`}
                                        onClick={() => {
                                            if (orderType !== "MARKET") {
                        ...
                        {/* Percentage Buttons */}
                        <div className="dc-h-24 dc-flex dc-w-full dc-items-center dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-white dc-border-opacity-6 dc-rounded-[8px] dc-mb-6">
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 10 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(10)}
                            >
                                10%
                            </button>
                            <button
                                className={`dc-w-1/5 dc-h-16 dc-flex dc-items-center dc-justify-center dc-text-10 ${calculatedPercentage === 25 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(25)}
                            >
                                25%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 50 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(50)}
                            >
                                50%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 75 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                                onClick={() => calculateQtyByPercentage(75)}
                            >
                                75%
                            </button>
                            <button
                                className={`dc-text-10 dc-flex dc-items-center dc-justify-center dc-w-1/5 dc-h-16 ${calculatedPercentage === 100 ? "dc-text-white dc-font-bold dc-bg-[#00D4FF] dc-rounded-[8px]" : "dc-text-[#898D99]"}`}
                        ...
                        <div className="dc-w-full dc-h-84 dc-flex dc-flex-col dc-items-center dc-justify-center dc-mb-6 dc-px-10 dc-py-5 dc-gap-3 dc-bg-white dc-bg-opacity-2 dc-border dc-border-white dc-border-opacity-6 dc-rounded-[8px]">
                            {/* Buy/Sell Prices */}
                        ...
                        {/* Action Buttons */}
                        <div className="dc-grid dc-w-full dc-h-48 grid-rows-2 dc-gap-3 dc-mb-6">
                            <button
                                className="dc-text-11 dc-bg-[#3FB185] dc-text-white dc-font-bold dc-rounded-[8px]"
                                onClick={() => handleClickBuySellModal("Long")}
                            >
                                {t('trading.buyLong')}
                            </button>
                            <button
                                className="dc-text-11 dc-bg-[#FF2B64] dc-text-white dc-font-bold dc-rounded-[8px]"
                        ...
                        {/* Account Info */}
                        <div className="dc-w-full dc-h-100 dc-p-5 dc-bg-white dc-bg-opacity-2 dc-border dc-border-white dc-border-opacity-6 dc-rounded-[8px] dc-mb-5">
                            <div className="dc-flex dc-justify-between dc-mb-2">
                            ...
                            <hr className="dc-border-opacity-6 dc-w-full dc-h-1 dc-my-4 dc-border dc-border-white" />
                        ...
                        <button
                            ...
                            className="dc-p-4 dc-w-full dc-h-30 dc-text-11 dc-bg-gradient-to-br dc-from-[#131416]/80 dc-to-[#0A0A0B]/80 dc-border dc-border-white dc-border-opacity-6 dc-text-white dc-rounded-[8px] dc-flex dc-items-center dc-justify-center"
                        >
            ...
            <div className="dc-mb-20">
                <div className="dc-min-h-300 dc-p-2">
                    {/* Tabs */}
                    <div className="dc-h-36 dc-flex dc-items-center dc-justify-between dc-mb-2">
                        <div className="dc-p-4 dc-flex dc-items-center dc-justify-between dc-bg-gradient-to-br dc-from-[#131416] dc-to-[#0A0A0B] dc-border dc-border-white dc-border-opacity-6 dc-rounded-[12px]">
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "Position" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[10px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Position")}
                            >
                                {t('trading.position')}({positions.length})
                            </button>
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "Current Orders" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[10px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Current Orders")}
                            >
                                {t('trading.currentOrders')}({orders.filter(order => order.status === "PENDING").length})
                            </button>
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "Order History" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[10px]" : "dc-text-white"}`}
                                onClick={() => setActiveOrderTab("Order History")}
                            >
                                {t('trading.orderHistory')}
                            </button>
                            <button
                                className={`dc-px-12 dc-h-24 dc-text-11 ${activeOrderTab === "PnL" ? "dc-text-white dc-bg-[#00D4FF] dc-rounded-[10px]" : "dc-text-white"}`}
                        ...
                        <div className="dc-relative">
                            <table className="dc-w-full dc-border-separate">
                                <thead className="dc-relative">
                                    <div className="dc-absolute dc-left-0 dc-top-3 dc-w-full dc-h-32 dc-bg-white dc-bg-opacity-2 dc-border-opacity-6 dc-border dc-border-white dc-rounded-[25px]" />
                                    <tr className="dc-text-10 dc-h-32 dc-text-white">
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.contracts')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.qty')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.value')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.entryPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.currentPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.liqPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.pMargin')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.mMargin')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.unrealizedPnl')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.realizedPnl')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.action')}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {positions.map((position, index) => {
                                        ...
                                        return (
                                            <tr key={index} className="dc-text-10 dc-h-36">
                                                ...
                                                <td className="dc-text-center">
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <>
                                                                <span className={`dc-text-[${textColor}]`}>{Number(pnl.toFixed(1)).toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 })} USDT</span>
                                                ...
                                                <td className="dc-text-center dc-text-[#FF2B64]">{Number(-(Number(position.quantity) * Number(position.entry_price) * (mockConfig?.market_order_fee_rate || 0.055) * 0.01).toFixed(1)).toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 })} USDT</td>
                                                <td className="dc-text-center">
                        ...
                        <div className="dc-relative">
                            <table className="dc-w-full dc-border-separate">
                                <thead className="dc-relative">
                                    <div className="dc-absolute dc-left-0 dc-top-3 dc-w-full dc-h-32 dc-bg-white dc-bg-opacity-2 dc-border-opacity-6 dc-border dc-border-white dc-rounded-[25px]" />
                                    <tr className="dc-text-10 dc-h-32 dc-text-white">
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.symbol')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.qty')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.tradeType')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderType')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderNo')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderTime')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.cancel')}</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table className="dc-w-full dc-border-separate">
                                <thead className="dc-relative">
                                    ...
                                    <tr className="dc-text-10 dc-h-32 dc-text-white">
                                        ...
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.qty')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.executionPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.tradeType')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderType')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.status')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderNo')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.orderTime')}</th>
                                    </tr>
                                </thead>
                            ...
                            <table className="dc-w-full dc-border-separate">
                                <thead className="dc-relative">
                                    ...
                                    <tr className="dc-text-10 dc-h-32 dc-text-white">
                                        ...
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.qty')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.entryPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.liquidationPrice')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.tradeType')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.closingPnl')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.entryFee')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.closingFee')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.fundingFee')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.liquidationType')}</th>
                                        <th className="dc-font-normal dc-text-center dc-align-middle">{t('trading.liquidationTime')}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {pnls.map((pnl, index) => (
